        ...
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="position-relative mb-4">
                    ...
                    <button type="button"
                        class="btn btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2">Qeydiyyatdan
                        keçmək</button>
                </div>
                <div class="d-flex pt-1 m-n1">
                    <a class="btn btn-lg-square btn-dark text-primary m-1" href=""><i style="color: #D7B56D !important"
                    ...
                    <a class="btn btn-lg-square btn-dark text-primary m-1"
                        href="https://www.instagram.com/xl.barbershop/?hl=de"><i style="color: #D7B56D !important"
